...
A_nullstelleBisektion = fzero(@fa,4) % Nullstelle Bisektion
A_nullstelleOptimiert = fsolve(@fa,4) % Nullstelle Newton
...
D_nullstelleBisektion = fzero(@fd,4) 
D_nullstelleOptimiert = fsolve(@fd,4) % Nullstelle Newton
